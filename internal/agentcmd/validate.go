...
func NewValidateCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Reports baseline MCP tools (46) and info/news shortcuts (10) whose CLI paths are missing from the runnable cobra tree. Use in CI after adding MCP tools or shortcuts.",
